        ...
        document.getElementById('btn-play-again').addEventListener('click', function () {
            ...
            function renderBoard() {
                ...
                document.querySelectorAll('.sq').forEach(function (sqEl) {
                    ...
                    .call(sqEl.querySelectorAll('.piece,.dot,.ring'))
                    .forEach(function (n) {
                        n.remove();
                    });
                    ...
                    var target = legalTargets.find(function (m) {
                        return m.to === square;
                    });
                    if (target) {
            ...
            function renderCaptured() {
                ...
                document.getElementById('captured-white').innerHTML = capturedByBlack
                .map(function (s) {
                    return '<span>' + s + '</span>';
                })
                .join('');
                document.getElementById('captured-black').innerHTML = capturedByWhite
                .map(function (s) {
                    return '<span>' + s + '</span>';
                })
                .join('');
